...
public final class MessagesSearchResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<MessagesShowRecordingResponse> shows;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<MessagesShowRecordingResponse> getShows() {
    return shows;
  }
   ...
   */
  public MessagesSearchResponse setShows(java.util.List<MessagesShowRecordingResponse> shows) {
    this.shows = shows;
    return this;
  }
